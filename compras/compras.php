...
$compras = obtenerCompras($conexion);
if (!$compras) {
    echo "Error al obtener datos de compras.";
...
?>
    ...
    <!-- Titulo Productos -->
     <nav class="nav-links">
        <div class="label-productos">
            ...
            <!-- <img src="compras/imgs/tienddda.png" alt="Decoración" class="imagen-2"> -->
            <!-- icono -->
    ...
    <!-- Titulo Productos -->
        ...
        <table class="tabla_comm">
            <thead class=encabezado_tabla>
                <tr>
                <th class="item_tabla enc descripcion">Nro</th>
            ...
            <tbody>
                ...
                ?>
                    <tr>
                        ...
                        <td class="item_tabla body"><?= htmlspecialchars($compra['Nro']) ?></td>
                        <td  class="ocultar"><?= htmlspecialchars($compra['id']) ?></td>
