...
$stmt->bind_param("ssssssssssssssi", $nombre, $apellido, $sexo, $fecha_nacimiento, $tipo_documento, $nro_documento, $foto, $direccion, $telefono, $email, $estado, $username, $password, $tipo_usuario, $id);
...
if ($stmt->execute()) {
    ...
    echo "<br><a href='mostrar_foto.php?id=" . $id . "'>Mostrar Foto</a>";
